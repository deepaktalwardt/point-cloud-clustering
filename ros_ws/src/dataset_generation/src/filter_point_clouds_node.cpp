...
int main()
{
    ...
    pcf.apply_voxel_filter_and_visualize(in_folder_pcd,out_folder_pcd,0.05,0.05,0.05);
    pcf.apply_voxel_filter_and_save(in_folder_pcd,out_folder_pcd,0.05,0.05,0.05);
}
